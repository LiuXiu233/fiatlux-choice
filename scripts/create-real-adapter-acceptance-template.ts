  ...
  return {
    ...
    llm: {
      ...
      credential: {
        ...
        rawCredentialRecorded: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
        injectedIntoServices: ["REPLACE_WITH_WORKER_ONLY_AFTER_VERIFICATION"],
        secretStoreReference: "REPLACE_WITH_SECRET_STORE_REFERENCE_NOT_SECRET",
      },
      ...
      qualitySamples: realAdapterAdvisorKeys.map((advisor) => ({
        ...
        mockOrSyntheticProvider: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
      ...
      dataProcessing: {
        ...
        personalInformationSentInAcceptance: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
        sensitivePersonalInformationSentInAcceptance: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
    ...
    drills: {
      ...
      fallback: {
        ...
        externalNetworkCallsObserved: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
        configEvidenceArtifactId: "fallback-config",
      },
    },
    privacy: {
      rawCredentialsCaptured: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
      authorizationHeadersCaptured: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
      sessionCookiesCaptured: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
      rawProviderResponsesExported: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
      companyDataRedactedInArtifacts: false,
      personalInformationInArtifacts: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
      repositorySecretsInArtifacts: "REPLACE_WITH_FALSE_AFTER_VERIFICATION",
