...
| 官网与电竞教育 | 已完成 fiatlux.gg 公开业务/内容审计、内部教育筹备页、成年人 4–6 周试点课程草案，以及按 4 篇基础包和 8 篇扩展包维护的 12 篇版本化内容；每篇均含 Schema、来源、权利、AI 披露、模板、练习和复核问题；mock、独立原生浏览器和真实栈 desktop/mobile 均已浏览 12 篇列表及新增正文 | 已实现 / 本地浏览器通过 / 待业务与专业复核 | 十二篇仍是 `pending`/`pending_clearance`/`not_published`；修复 7 篇模板占位、地域/时态/见证/隐私投诉问题；九项事实问卷及逐篇合同、隐私、版权、退款、健康、事实和内容安全批准后才可人工发布 |
