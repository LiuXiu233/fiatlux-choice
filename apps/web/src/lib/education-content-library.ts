...
/**
 * Builds the governed library from independently maintained content packages without
 * reading working-tree JSON at module load. Admin tools can therefore validate content
 * extracted from an exact Git commit rather than accidentally mixing candidate and HEAD.
 */
