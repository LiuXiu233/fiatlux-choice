...
export const resources: Record<string, ResourceConfig> = {
  ...
  decisions: {
    ...
    title: "决策",
    singular: "决策",
    description: "记录决策背景、结论与后续证据；同时选择目标、项目或任务时必须属于同一业务链",
    icon: Lightbulb,
  ...
  opportunities: {
    ...
    title: "市场机会",
    singular: "机会",
    description: "赞助、赛事、教育客户与合作机会管道；同时选择产品和项目时必须与产品所属项目一致",
    icon: Target,
